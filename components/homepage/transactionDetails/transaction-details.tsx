...
import TransactionDetailsFilter from "@/components/homepage/transactionDetails/filter"
import TransactionRow from "@/components/homepage/transactionDetails/transaction-row"
    ...
    <div className={"mt-8 flex flex-col gap-8"}>
      <div className={"flex items-end justify-between w-full"}>
        <div>
          ...
          <p className={"font-light"}>You had 2 incomes and 34 expenses</p>
        </div>
